...
export function HomeView(): JSX.Element {
    ...
    return (
        <section className="h-screen w-screen">
            ...
            <ContentContainer>
                <div className="pt-[2.6rem] px-lg relative max-lg:px-0 max-lg:pt-0">
                ...
                <div className="w-[50%] mx-auto py-[7.2rem] flex flex-col gap-lg max-sm:w-[95%] max-lg:w-[80%] max-lg:py-sm bold">
                    <DefaultText className="w-full text-center text-emphasis max-lg:text-subtitle leading-normal">Clear space in your wardrobe and earn Farfetch credit by selling you designer bags through our Second Life service.*</DefaultText>
